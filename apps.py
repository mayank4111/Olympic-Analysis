...
df=pd.read_csv(r'C:\Users\MAYANK\Desktop\my document\Olmpic data Analysis Azure\athlete_events.csv')
region_df=pd.read_csv(r'C:\Users\MAYANK\Desktop\my document\Olmpic data Analysis Azure\noc_regions.csv')
